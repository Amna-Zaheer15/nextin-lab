...
<body>
    <div class="container">
        <h1>
            Edit Course
            <a href="/admin/courses" class="close-form">Close</a>
        </h1>
            ...
            <form id="courseForm" action="{{ route('courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group file-upload">
                        ...
                        <input type="file" id="thumbnail" name="thumbnail" class="form-control" accept="image/*" onchange="previewImage(this, 'thumbnailPreview')">
                        @if($course->thumbnail)
    ...
    <script>
        // Text formatting functions for the rich text editors
        ...
        function updateHiddenInput(editorId, hiddenInputId) {
            document.getElementById(hiddenInputId).value = document.getElementById(editorId).innerHTML;
        }
        ...
        function addNumberedTopic() {
            const topicsEditor = document.getElementById('topics');
            topicsEditor.focus();
        ...
        // Close color options when clicking elsewhere
        document.addEventListener('click', function(e) {
            if (!e.target.matches('.color-picker button')) {
                document.querySelectorAll('.color-options').forEach(function(options) {
                    options.classList.remove('show-color-options');
                });
            }
        });
        
        // Initialize hidden inputs with current content
